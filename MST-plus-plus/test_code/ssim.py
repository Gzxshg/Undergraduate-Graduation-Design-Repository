...
if __name__ == "__main__":
    gt_dir = "/root/autodl-tmp/BiSRNet-Plus-Plus/datasets/Valid_Spec"       # 真实图像 mat 文件目录
    rec_dir = "/root/autodl-tmp/exp/bisrnet_plus_plus/Valid_MAT"     # 预测/重建 mat 文件目录
